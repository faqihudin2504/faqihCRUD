                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo base_url('admin/update-admin'); ?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?php echo $data_admin['username_admin'];?>" readonly="readonly" onKeyPress="return goodchars(event, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789', this)" name="username" placeholder="Masukkan Username Admin" required="required">
                        </div>
                        <div style="clear:both;"></div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <a href="<?php echo base_url('admin/master-data-admin');?>"><button type="button" class="btn btn-danger">Batal</button>
                    </div>
                    <div style="clear:both"></div>
                    </form>
                </div>
